...
$.ajax({
    ...
    data: {
        key: '5BZBZ-VFQWZ-CCIXF-TNMOI-GPBV3-RFFWJ',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
                ...
                case "江苏省":
                    switch (ipLoacation.result.ad_info.city) {
                        ...
                        case "苏州市":
                            ...
                            break;
                        case "泰州市":
                            posdesc = "州建南唐，文昌北宋，名城名宦交相重。 月华如练旧亭台，清词范晏人争诵。 朗润明珠，翩仙彩凤，梅郎合受千秋供。 重光殿宇古招提，放翁大笔今堪用。。";
                            break;
                        default:
                            posdesc = "散装是必须要散装的。";
                            break;
    ...
    else if (date.getHours()>= 1 && date.getHours() < 13) timeChange = "<span>中午好</span>，要好好吃饭哦~";
